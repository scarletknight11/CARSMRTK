...
namespace ItSeez3D.AvatarSdk.Core
{
	...
	public static class ImageUtils
	{
		...
		{
			var textureRequest = UnityWebRequestTexture.GetTexture("file://" + textureFilename);
		...
		private static IEnumerator LoadNormalMapTextureFunc(string textureFilename, AsyncRequest<Texture2D> request)
		{
			...
			{
				Texture2D normalMapTexture = new Texture2D(texture.width, texture.height, TextureFormat.RGB24, true, true);
				normalMapTexture.SetPixels32(texture.GetPixels32());
