...
namespace ItSeez3D.AvatarSdk.Core
{
	...
	public class HaircutRecoloring : MonoBehaviour
	{
		...
		public void ResetHaircutMaterial(Material haircutMaterial, Color averageColor, Color defaultColor)
		{
			this.defaultColor = defaultColor;
			this.haircutMaterial = haircutMaterial;
		...
		public void ResetHaircutMaterial(Material haircutMaterial, Color averageColor, Color defaultColor, Color currentColor)
		{
			this.defaultColor = defaultColor;
			this.haircutMaterial = haircutMaterial;
			this.averageColor = averageColor;
