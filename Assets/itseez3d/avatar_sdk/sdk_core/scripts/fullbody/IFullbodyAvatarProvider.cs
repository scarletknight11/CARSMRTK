...
namespace ItSeez3D.AvatarSdk.Core
{
	public interface IFullbodyAvatarProvider: IAvatarProvider
	{
		...
		/// </summary>
		AsyncRequest<string> InitializeFullbodyAvatarAsync(string selfieCode, byte[] selfiePhotoBytes, FullbodyAvatarComputationParameters computationParameters, string name = "name", string description = "");
		...
		/// </summary>
		AsyncRequest<FullbodyAvatarComputationParameters> GetAvailableComputationParametersAsync();
	}
}
